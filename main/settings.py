...
# Create required directories for logging and media
Path(BASE_DIR / 'logs').mkdir(parents=True, exist_ok=True)
Path(BASE_DIR / 'media').mkdir(parents=True, exist_ok=True)
Path(BASE_DIR / 'staticfiles').mkdir(parents=True, exist_ok=True)
...
MIDDLEWARE = [
    ...
    # 'app.middleware.RestrictMobileMiddleware',
]
...
CORS_ALLOWED_ORIGINS = config(
    ...
    default='http://localhost:19000,http://localhost:19001,http://localhost:3000',
    cast=Csv()
)
